...
const crudResolversInfo = {
    ...
    UserContact: ["aggregateUserContact", "createOneUserContact", "deleteManyUserContact", "deleteOneUserContact", "findFirstUserContact", "userContacts", "userContact", "groupByUserContact", "updateManyUserContact", "updateOneUserContact", "upsertOneUserContact"],
    Message: ["aggregateMessage", "createOneMessage", "deleteManyMessage", "deleteOneMessage", "findFirstMessage", "messages", "message", "groupByMessage", "updateManyMessage", "updateOneMessage", "upsertOneMessage"],
    Conversation: ["aggregateConversation", "createOneConversation", "deleteManyConversation", "deleteOneConversation", "findFirstConversation", "conversations", "conversation", "groupByConversation", "updateManyConversation", "updateOneConversation", "upsertOneConversation"],
    Paticipants: ["aggregatePaticipants", "createOnePaticipants", "deleteManyPaticipants", "deleteOnePaticipants", "findFirstPaticipants", "findManyPaticipants", "findUniquePaticipants", "groupByPaticipants", "updateManyPaticipants", "updateOnePaticipants", "upsertOnePaticipants"]
};
const argsInfo = {
...
const inputsInfo = {
    ...
    MessageCreateNestedManyWithoutFromUserInput: ["create", "connectOrCreate", "connect"],
    PaticipantsCreateNestedManyWithoutUserInput: ["create", "connectOrCreate", "connect"],
    UserContactCreateNestedManyWithoutOwnerContactInput: ["create", "connectOrCreate", "connect"],
    UserContactCreateNestedManyWithoutContactUserInput: ["create", "connectOrCreate", "connect"],
    ConversationCreateNestedManyWithoutCreatorInput: ["create", "connectOrCreate", "connect"],
    StringFieldUpdateOperationsInput: ["set"],
    NullableStringFieldUpdateOperationsInput: ["set"],
    BoolFieldUpdateOperationsInput: ["set"],
    IntFieldUpdateOperationsInput: ["set", "increment", "decrement", "multiply", "divide"],
    MessageUpdateManyWithoutFromUserNestedInput: ["create", "connectOrCreate", "upsert", "set", "disconnect", "delete", "connect", "update", "updateMany", "deleteMany"],
    PaticipantsUpdateManyWithoutUserNestedInput: ["create", "connectOrCreate", "upsert", "set", "disconnect", "delete", "connect", "update", "updateMany", "deleteMany"],
    UserContactUpdateManyWithoutOwnerContactNestedInput: ["create", "connectOrCreate", "upsert", "set", "disconnect", "delete", "connect", "update", "updateMany", "deleteMany"],
    UserContactUpdateManyWithoutContactUserNestedInput: ["create", "connectOrCreate", "upsert", "set", "disconnect", "delete", "connect", "update", "updateMany", "deleteMany"],
    ConversationUpdateManyWithoutCreatorNestedInput: ["create", "connectOrCreate", "upsert", "set", "disconnect", "delete", "connect", "update", "updateMany", "deleteMany"],
    ...
    PaticipantsCreateNestedManyWithoutConversationInput: ["create", "connectOrCreate", "connect"],
    UserUpdateOneRequiredWithoutConversationNestedInput: ["create", "connectOrCreate", "upsert", "connect", "update"],
    MessageUpdateManyWithoutConversationNestedInput: ["create", "connectOrCreate", "upsert", "set", "disconnect", "delete", "connect", "update", "updateMany", "deleteMany"],
    PaticipantsUpdateManyWithoutConversationNestedInput: ["create", "connectOrCreate", "upsert", "set", "disconnect", "delete", "connect", "update", "updateMany", "deleteMany"],
